...
//orientation="horizontal";
style=menuStyle;
aI("text=Logout;url=http://localhost:8080/AutoLib;");
}
...
aI("text=Book1;url=http://localhost:8080/AutoLib/Book/BookServlet?flag=loadBook;");
aI("text=Course;url=http://localhost:8080/AutoLib/Course;");
aI("text=Binding;url=http://localhost:8080/AutoLib/Binding;");
...
aI("text=Binding Books;url=http://localhost:8080/AutoLib/Binding_Books/BindingAction?flag=load;");
aI("text=Transfer Books;url=http://localhost:8080/AutoLib/Transfer_Books/TransferAction?flag=load;");
}
...
aI("text=AccessionRegister;url=http://localhost:8080/AutoLib/AccessionRegister;");
aI("text=Statistics Report;url=http://localhost:8080/AutoLib/Statistics;");
aI("text=Member;url=http://localhost:8080/AutoLib/MemberReport;");
aI("text=Journal List;url=http://localhost:8080/AutoLib/JournalList;");
aI("text=Journal Issues;url=http://localhost:8080/AutoLib/JnlIssueReport;");
aI("text=No Dues Certificate;url=http://localhost:8080/AutoLib/NoDues;");
aI("text=Frequently Used Resource;url=http://localhost:8080/AutoLib/FrequentlyUsedResource/FreqUsedIndex;");
}
...
orientation="horizontal";
style=menuStyle;
aI("text=Fine Mas;url=http://localhost:8080/AutoLib/Fine;");
aI("text=Holiday;url=http://localhost:8080/AutoLib/Holiday;");
aI("text=Budget;url=http://localhost:8080/AutoLib/Budget;");
aI("text=Group;url=http://localhost:8080/AutoLib/Group;");
aI("text=Login;url=http://localhost:8080/AutoLib/Login;");
aI("text=Stock;url=http://localhost:8080/AutoLib/Stock/StockServlet?flag=LOAD;");
...
aI("text=Advanced Search;url=http://localhost:8080/AutoLib/Advanced;");
aI("text=Browse;url=http://localhost:8080/AutoLib/Browse;");
aI("text=Check Account;url=http://localhost:8080/AutoLib/Account;");
aI("text=Gate Register;url=http://localhost:8080/AutoLib/Account/AccountServlet?flag=register;");
}
drawMenus();
