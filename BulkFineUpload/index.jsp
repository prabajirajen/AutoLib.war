...
<jsp:useBean id="bean" scope="request" class="Lib.Auto.BulkFineUpload.FineDataMessage" type="Lib.Auto.BulkFineUpload.FineDataMessage">
</jsp:useBean>
...
<form name="fineimport" enctype="multipart/form-data" method="post" action=./FineImportServlet>

<br><br><br>

 <h2>Bulk Fine Upload</h2>
<center>
...
function SaveRec(){
             document.fineimport.method="post";
            
                
	    if(chk_mc()){				   
		         	 document.fineimport.submit();
...
var flag_cs;
var c;
var mc=document.fineimport.bfile.value;
if(mc=="")
{				
				document.fineimport.flag.value="none";
				document.fineimport.bfile.value="";
				return false;
				}
				else{
		        return true;
...
function ClearRec(){ 
				...
				document.fineimport.flag.value="none";
				document.fineimport.action="index.jsp";
				document.fineimport.submit();	   	
