...
foldersTree = gFld("<i>Autolib Software Systems</i>", "")
  aux1 = insFld(foldersTree, gFld("Cataloging", "javascript:parent.op()"))
	  ...
	  insDoc(aux1, gLnk("R", "Keywords", "http://localhost:8080/AutoLib/Keywords"))
  ...
  aux1 = insFld(foldersTree, gFld("Circulation", "javascript:parent.op()"))
	  ...
	  //insDoc(aux1, gLnk("R", "Binding Books", "http://localhost:8080/AutoLib/Binding_Books/BindingIndex"))
  ...
  aux1 = insFld(foldersTree, gFld("Serial Control", "javascript:parent.op()"))
     ...
     // insDoc(aux1, gLnk("B", "Journal Issues", "http://localhost:8080/AutoLib/Journal_Issues"))
	  ...
	  insDoc(aux1, gLnk("R", "Journal Articles", "http://localhost:8080/AutoLib/Journal_Artical"))

  aux1 = insFld(foldersTree, gFld("Reports", "javascript:parent.op()"))
         // insDoc(aux1, gLnk("R", "LibraryCollections", "http://localhost:8080/AutoLib/LibraryCollection/CollectionIndex"))
	  ...
	  //insDoc(aux1, gLnk("R", "No Dues Certificate", "http://localhost:8080/AutoLib/NoDues"))
  ...
  aux1 = insFld(foldersTree, gFld("Admin", "javascript:parent.op()"))
	 ...
	 insDoc(aux1, gLnk("R", "Budget", "http://localhost:8080/AutoLib/Budget"))
	  ...
	  //insDoc(aux1, gLnk("R", "Stock Verification", "http://localhost:8080/AutoLib/Stock/StockIndex"))

  aux1 = insFld(foldersTree, gFld("Book Search", "javascript:parent.op()"))
          insDoc(aux1, gLnk("B", "Simple Search", "http://localhost:8080/AutoLib/Simples"))
    	 insDoc(aux1, gLnk("B", "Advanced Search", "http://localhost:8080/AutoLib/Advanced"))
