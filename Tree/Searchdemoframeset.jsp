 ...
 <li>
	...
	<a href="#">Circulation</a>
		<ul>
			...
			<li><a href="<%= request.getContextPath() %>/UserLock/">User&nbsp;Lock</a></li>
			<li><a href="<%= request.getContextPath() %>/UserClearance/">User&nbsp;Clearance</a><</li>
...
<%--           <li><a href="<%= request.getContextPath() %>/PaymentInfo/PaymentInfoServlet">Payment Report</a></li> --%>
   ...
   <%-- <li><a href="#">Indent&nbsp;Reports&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>></a>
    <ul>
          ...
          <li><a href="<%= request.getContextPath() %>/FrequentlyUsedMember/">FreqMember</a></li>
