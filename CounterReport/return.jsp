...
/*--------------------------DOC TYPE FOR ALL----------------------------*/
	...
	/* strsqlq = "select * from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" order by  "+order; */
	//out.print(strsqlq);
	strsqlq = "select * from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='BOOK' order by  "+order;
	...
	out.print("<th>Sno</th><th>MemCode</th><th>MemName</th><th>AccNo</th><th>Title</th><th>ReturnDate</th><th>Staff-In-charge</th><th>Department</th><th>Group</th><th>Course</th>");
	...
	strsqlq = "select * from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='THESIS' order by  "+order;
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	out.print("</table>");
 	...
 	strsqlq = "select * from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='BACK VOLUME' order by  "+order;
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	out.print("</table>");
 	...
 	strsqlq = "select * from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='PROCEEDING' order by  "+order;
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	out.print("</table>");
 	...
 	strsqlq = "select * from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='REPORT' order by  "+order;
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	out.print("</table>");
 	...
 	strsqlq = "select * from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='NON BOOK' order by  "+order;
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	out.print("</table>");
 	...
 	strsqlq = "select * from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='STANDARD' order by  "+order;
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	{
	strsqlq="select count(*) as count_book, return_date from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" group by return_date order by return_date";
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	out.print("<br><br><table border=1 width=700 align=center CELLSPACING='0' BORDERCOLOR='#DADADA' BGCOLOR='#F5F5F5'> ");
	out.print("<th>Sno</th><th>ReturnDate</th><th>No Of Books</th>");
...
/*----------------------------BOOK DOC----------------------------------------------------------------------------------------------------------------*/
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, return_date from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='BOOK' group by return_date order by return_date";
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, return_date from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='BOOK BANK' group by return_date order by return_date";
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	/*----------------------------JOURNALS DOC----------------------------------------------------------------------------------------------------------------*/
		...
		if(report_type.equals("listing"))
		{
		strsqlq = "select * from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='JOURNAL' order by  "+order;
		//strsql="select * from juserstat where issue_date="+Today_Date+" and //return_date="+Today_Date+" "+strsql+" order by return_date";
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, return_date from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='JOURNAL' group by return_date order by return_date";
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
...
/*----------------------------THESIS DOC----------------------------------------------------------------------------------------------------------------*/
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, return_date from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='THESIS' group by return_date order by return_date";
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
...
/*----------------------------BACK VOLUME----------------------------------------------------------------------------------------------------------------*/
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, return_date from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='PROCEEDING' group by return_date order by return_date";
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, return_date from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='REPORT' group by return_date order by return_date";
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, return_date from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='NON BOOK' group by return_date order by return_date";
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
...
/*----------------------------STANDARD----------------------------------------------------------------------------------------------------------------*/
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, return_date from Jhistory where 1<2 and issue_type='RETURN' "+strsql+" and doc_type='STANDARD' group by return_date order by return_date";
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
