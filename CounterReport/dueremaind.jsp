...
if ((txtreporttype.equals("Duereminder")) && (txtdoctype.equals("ALL"))){
	...
	out.print("<center><font size=5>DUE REMAINDER REPORT</center></font>");
	...
	strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='BOOK'  and issue_mas.member_code=member_mas.member_code order by  "+order+"";
	//out.print(strsqlq);
	...
	strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='THESIS'  and issue_mas.member_code=member_mas.member_code order by  "+order+"";
	//out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='BACK VOLUME'  and issue_mas.member_code=member_mas.member_code order by  "+order+"";
	//out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='PROCEEDING'  and issue_mas.member_code=member_mas.member_code order by  "+order+"";
	//out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='REPORT'  and issue_mas.member_code=member_mas.member_code order by  "+order+"";
	//out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='NON BOOK'  and issue_mas.member_code=member_mas.member_code order by  "+order+"";
	//out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='STANDARD'  and issue_mas.member_code=member_mas.member_code order by  "+order+"";
	//out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	{
	strsqlq="select count(*) as count_book, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and  issue_mas.member_code=member_mas.member_code group by issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date, issue_mas.due_date  order by  "+order+"";
...
// CODE FOR DUE REMAINDER BOOK
	...
	if(report_type.equals("listing"))
	{
strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='BOOK' and issue_mas.member_code=member_mas.member_code order by  "+order+"";  /* "+strsql+"";  and Issue_Type='ISSUE' order by  "+order; */
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='BOOK' and  issue_mas.member_code=member_mas.member_code group by issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date, issue_mas.due_date  order by  "+order+"";
...
// CODE FOR DUE REMAINDER THESIS
	...
	if(report_type.equals("listing"))
	{
strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='THESIS' and issue_mas.member_code=member_mas.member_code order by  "+order+"";  /* "+strsql+"";  and Issue_Type='ISSUE' order by  "+order; */
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='THESIS' and  issue_mas.member_code=member_mas.member_code group by issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date, issue_mas.due_date  order by  "+order+"";
...
// CODE FOR DUE REMAINDER BACK VOLUME
	...
	if(report_type.equals("listing"))
	{
strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='BACK VOLUME' and issue_mas.member_code=member_mas.member_code order by  "+order+"";  /* "+strsql+"";  and Issue_Type='ISSUE' order by  "+order; */
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='BACK VOLUME' and  issue_mas.member_code=member_mas.member_code group by issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date, issue_mas.due_date  order by  "+order+"";
...
// CODE FOR DUE REMAINDER PROCEEDING
	...
	if(report_type.equals("listing"))
	{
strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='PROCEEDING' and issue_mas.member_code=member_mas.member_code order by  "+order+"";  /* "+strsql+"";  and Issue_Type='ISSUE' order by  "+order; */
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='PROCEEDING' and  issue_mas.member_code=member_mas.member_code group by issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date, issue_mas.due_date  order by  "+order+"";
...
// CODE FOR DUE REMAINDER REPORTS
	...
	if(report_type.equals("listing"))
	{
strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='REPORT' and issue_mas.member_code=member_mas.member_code order by  "+order+"";  /* "+strsql+"";  and Issue_Type='ISSUE' order by  "+order; */
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='REPORT' and  issue_mas.member_code=member_mas.member_code group by issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date, issue_mas.due_date  order by  "+order+"";
...
// CODE FOR DUE REMAINDER NON BOOKS


	if ((txtreporttype.equals("Duereminder")) && (txtdoctype.equals("NON BOOK"))){
	if(report_type.equals("listing"))
	{
strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='NON BOOK' and issue_mas.member_code=member_mas.member_code order by  "+order+"";  /* "+strsql+"";  and Issue_Type='ISSUE' order by  "+order; */
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='NON BOOK' and  issue_mas.member_code=member_mas.member_code group by issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date, issue_mas.due_date  order by  "+order+"";
...
// CODE FOR DUE REMAINDER STANDARD
	...
	if(report_type.equals("listing"))
	{
strsqlq = "select member_mas.member_name, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='STANDARD' and issue_mas.member_code=member_mas.member_code order by  "+order+"";  /* "+strsql+"";  and Issue_Type='ISSUE' order by  "+order; */
	out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
	...
	if(report_type.equals("breakup"))
	{
	strsqlq="select count(*) as count_book, issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date,issue_mas.due_date from issue_mas, member_mas where 1<2 "+strsql+" and doc_type='STANDARD' and  issue_mas.member_code=member_mas.member_code group by issue_mas.member_code, issue_mas.access_no, issue_mas.issue_date, issue_mas.due_date  order by  "+order+"";
