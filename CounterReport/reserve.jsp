...
// CODE FOR RESERVE
  ...
  if ((txtreporttype.equals("Reserve")) && (txtdoctype.equals("ALL"))){
	...
	{
   	/* strsqlq = "select reserve_mas.member_code, reserve_mas.id, reserve_mas.access_no, reserve_mas.doc_type, reserve_mas.res_date, member_mas.member_name from reserve_mas, member_mas where 1<2 and member_mas.member_code=reserve_mas.member_code "+strsql+" order by  "+order+""; */
	...
	out.print("</table>");
	strsqlq = "select reserve_mas.member_code, reserve_mas.id, reserve_mas.access_no, reserve_mas.doc_type, reserve_mas.res_date, member_mas.member_name from reserve_mas, member_mas where 1<2 and member_mas.member_code=reserve_mas.member_code "+strsql+" and doc_type='BOOK' order by  "+order+"";
	out.print(strsqlq);
	...
	while(rs.next())
	{
		...
		out.print("<td><font size=2>"+rs.getString("id")+"</td>");
		...
		out.print("<td><font size=2>"+rs.getString("doc_type")+"</td>");
	...
	strsqlq = "select reserve_mas.member_code, reserve_mas.id, reserve_mas.access_no, reserve_mas.doc_type, reserve_mas.res_date, member_mas.member_name from reserve_mas, member_mas where 1<2 and member_mas.member_code=reserve_mas.member_code "+strsql+" and doc_type='PROCEEDING' order by  "+order+"";
	//out.print(strsqlq);
	rs=st.executeQuery(strsqlq);
	if(!rs.next())
	{
