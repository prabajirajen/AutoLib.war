...
<!-- <input type=radio value="1" name="antennaid">1&nbsp;<input type=radio value="2" name="antennaid">2&nbsp;<input type=radio value="3" name="antennaid">3&nbsp;<input type=radio value="4" name="antennaid">4&nbsp; -->
<!-- </td> -->
<!-- </tr> -->
<tr></tr>
<tr>
...
/*---------------------------------------MERGE DETAILS----------------------------------------------------------------------------------------------------------------------------------------------------------*/
                    ...
                    out.print("<tr><th>S.No<th>Member&nbsp;Code<th>CardUID<th>Member&nbsp;Name</tr>");
            		%>
            		<script>
                    document.write("<td><b>"+"<%=i%>" +"</td>");
        		 	document.write("<td><b>"+"<%=bean.getMcode()%>" +"</td>");
        		 	document.write("<td><b>"+"<%=bean.getCarduid()%>" +"</td>");
        		 	document.write("<td><b>"+"<%=bean.getMname()%>" +"</td>");
        		 	</script><%
          }
 }
%>
...
function save()
{
		...
		if(document.tagmerging.CardUid.value!="" && document.tagmerging.mcode.value!="")
		{
			document.tagmerging.flag.value="CardUID";
...
function rsetpage(){
	...
	document.tagmerging.flag.value="resetcard";
	document.tagmerging.submit();
	}
