...
String flag="",flag1="",antenaid="",Message="",load="",detils="",Reservedetils="",flags="",avoid="",DisplayDate="",DisplayDate1="";
%>
...
<tr><td> &nbsp; </td></tr>
    ...
    <tr>
      ...
      <td><input type="text" class="uppercase" name="mcode" id="user" size="17"  maxlength="15" onFocus="memopt()" >
       <input type=button name=Find_Member Class="submitButton" Value="Find" onclick=FindValue('Member')></td>
      <td bgcolor="#BCD6E2" bordercolor="#FFE6BC"><input type="radio" value="V1" checked name="sel_search"><b>User</b></td>
...
<img src="photo.jsp"  height="100px" width="100px" align="right"/></td>
...
<img src="<%=request.getContextPath() %>/images/noimage.jpg" height="100px" width="100px" align="right"/></td>
    ...
    <tr>
      ...
      <td Class="addedit">Valid Date</td>
      <td ><input type="text" readonly="true" name="validDate" size="12"></td>
    ...
    <tr>
      ...
      <td ><input type="text" readonly="true" name="year" size="12"></td>
...
%>
      ...
      <td >&nbsp;<input type="radio"  name="sel_search" Class="addedit"><input type="text" name="barcode" size="8" maxlength="15"  onFocus="barcodeopt()" ></td>
    ...
    <tr>
      ...
      <td ><input type="text" name="accno" id="accid" class="uppercase" size="17" maxlength="15" onFocus="bookopt()" ></td><!--onfocus="bookopt()" -->
      <td Class="addedit">Call No</td>
      <td ><input type="text" readonly="true" name="callNo" size="12"></td>
    ...
    <tr>
      ...
      <td  colspan="3"><input type="text" readonly="true" name="title" size="63"></td>
    ...
    <tr>
      ...
      <td ><input type="text" readonly="true" name="doc" size="12"></td>
    ...
    <tr>
	 ...
	 <td Class="addedit">Publisher</td>
      ...
      <td ><input type="text" readonly="true" name="avail" size="12"></td>
    ...
    <tr>
        ...
        Return Date<input type="text" readonly="true" name="rdate" value="<%=Security_Counter.TodayDate_view()%>" size="12"> Fine<input type="text" name="fine" value="0.0"  size="6"></td>
    </tr>
    <tr>
      <td colspan="8"><center>
        <input onclick="issue()" type="button" Class="submitButton" value="F6-Issue">
        <input onclick="ireturn()" type="button" Class="submitButton" value="F7-Return">
		<input onclick="renew()" type="button" Class="submitButton" value="F9-Renew">
...
document.counter.flag1.value="return";
...
document.counter.method="post";
document.counter.flag1.value="renew";
document.counter.flag.value="savefine_payment";
document.counter.submit();
...
//------------------------------------------------------------flag end--------------------------------//
               ...
               if(document.counter.avail.value=="ISSUED" || document.counter.avail.value=="REFISSUED" || document.counter.avail.value=="TRANSISSUED" ){
				<%
...
/*---------------------------------------ISSUE DETAILS----------------------------------------------------------------------------------------------------------------------------------------------------------*/
                    ...
                    out.print("<tr><th>S.No<th>Access&nbsp;No<th>Title<th>Author<th>&nbsp;Issue&nbsp;Date&nbsp;<th>&nbsp;&nbsp;Due&nbsp;Date&nbsp;&nbsp;<th>Staff&nbsp;Code<th>Doc&nbsp;Type</tr>");
            		...
            		%>
            		 ...
            		 SimpleDateFormat sdf=new SimpleDateFormat("dd-MM-yyyy");
            		 java.util.Date todaydate=sdf.parse(today);
            		 String due=Security_Counter.getdate(sc.get(i+6).toString());
            		 java.util.Date duedate=sdf.parse(due);
            		 ...
            		 <script language=javascript>
            		 <%
            		 if(todaydate.after(duedate))//pending
            		 {%>
            		 	document.write("<td bgcolor='#F2F5A9'><b>"+"<%=j++%>" +"</td>");
            		 	document.write("<td bgcolor='#F2F5A9'><b>"+"<%=sc.get(i)%>" +"</td>");
            		 	document.write("<td bgcolor='#F2F5A9'><b>"+"<%=sc.get(i+1)%>" +"</td>");
            		 	document.write("<td bgcolor='#F2F5A9'><b>"+"<%=sc.get(i+2)%>" +"</td>");
            		 	document.write("<td bgcolor='#F2F5A9'><b>"+"<%=Security_Counter.getdate(sc.get(i+5).toString())%>"+"</td>");
				  		document.write("<td bgcolor='#F2F5A9'><b>"+"<%=Security_Counter.getdate(sc.get(i+6).toString())%>"+"</td>");
				  		document.write("<td bgcolor='#F2F5A9'><b>"+"<%=sc.get(i+8)%>"+"</td>");
	            		document.write("<td bgcolor='#F2F5A9'><b>"+"<%=sc.get(i+9)%>"+"</td>");
	            		document.write("</tr>");
            		 ...
            		 document.write("<td><font color='#08088A'><b>"+"<%=j++%>" +"</td>");
            		 document.write("<td><font color='#08088A'><b>"+"<%=sc.get(i)%>" +"</td>");
            		 document.write("<td><font color='#08088A'><b>"+"<%=sc.get(i+1)%>" +"</td>");
            		 document.write("<td><font color='#08088A'><b>"+"<%=sc.get(i+2)%>" +"</td>");
            		 document.write("<td><font color='#08088A'><b>"+"<%=Security_Counter.getdate(sc.get(i+5).toString())%>"+"</td>");
            		 document.write("<td><font color='#08088A'><b>"+"<%=Security_Counter.getdate(sc.get(i+6).toString())%>"+"</td>");
            		 document.write("<td><font color='#08088A'><b>"+"<%=sc.get(i+8)%>"+"</td>");
            		 document.write("<td><font color='#08088A'><b>"+"<%=sc.get(i+9)%>"+"</td>");
            		 document.write("</tr>");
            		 <%}%>
            		</script>
            		<%
...
// Edited by RK on 02-06-2014.
	
  		if(document.counter.avail.value=="YES" && parseInt(document.counter.geligible.value)> count)
		document.counter.submit();
		...
		//alert("TRANSSFERED Resource Can't Be Issued");
		...
		if((document.counter.idate.value) == (document.counter.ddate.value))
			alert("Document Already In Issued / Can not be issued to This User");
			//alert("Issuedddddddd Date and Due Date should not be same. This document can not be issued to you");
		...
		alert("Can't Issue JOURNELS  - Max JOURNELS  Already Issued ");
		}
		}
		}
...
// 	if(MFine!=0.0){
// 	msg = confirm("Do u Want to Return the Document with Fine?");
// 	if(msg){	
// 	}
// 	else
// 	{
...
// 	}
		...
		{
			alert("This Document Was Not Borrowed By This Member!");
		}
...
if(chk()){
		...
		else if(document.counter.avail.value=="ISSUED" || document.counter.avail.value=="TRANSISSUED")
		document.counter.submit();
		else if(document.counter.avail.value=="REFERENCE")
...
function reconnect()
{
	...
	var request;  
	var url="/AutoLib/Counter/RFIDServlet?flag=Reconnect";  
