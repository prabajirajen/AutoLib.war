<%@ page language="java" import="Common.Security"  import="java.io.*,java.util.ResourceBundle,java.sql.*,javax.naming.*,javax.sql.*"%>
<%!
int count=0;
%>
        <%!
...
<br><br><br>
<div >
<!--<A href=""  onclick="window.close()">login</a>-->
<A href="/AutoLib/index.html" ><img border='0' src='/AutoLib/images/Login.gif' ></a>
