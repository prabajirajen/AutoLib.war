...
public class ReserveRemaindAll extends HttpServlet{
...
if ((txtreporttype.equals("Resreminder")) && (txtdoctype.equals("ALL"))){
	...
	if(!order.equals("")){
	strsqlq = "select member_mas.member_name, reserve_mas.access_no, reserve_mas.res_date, reserve_mas.member_code from member_mas, reserve_mas, book_mas, sort_book where 1<2 and sort_book.access_no=reserve_mas.access_no "+strsql+" and doc_type='BOOK' and reserve_mas.access_no=book_mas.access_no and book_mas.availability='YES' and member_mas.member_code=reserve_mas.member_code order by n1,n2,n3";
	}
	else{
	...
	if(!order.equals("")){
		strsqlq = "select member_mas.member_name, reserve_mas.access_no, reserve_mas.res_date, reserve_mas.member_code from member_mas, reserve_mas, book_mas, sort_book where 1<2 and sort_book.access_no=reserve_mas.access_no "+strsql+" and doc_type='THESIS' and reserve_mas.access_no=book_mas.access_no and book_mas.availability='YES' and member_mas.member_code=reserve_mas.member_code order by n1,n2,n3";
		}
		else{
	...
	if(!order.equals("")){
		strsqlq = "select member_mas.member_name, reserve_mas.access_no, reserve_mas.res_date, reserve_mas.member_code from member_mas, reserve_mas, book_mas, sort_book where 1<2 and sort_book.access_no=reserve_mas.access_no "+strsql+" and doc_type='BACK VOLUME' and reserve_mas.access_no=book_mas.access_no and book_mas.availability='YES' and member_mas.member_code=reserve_mas.member_code order by n1,n2,n3";
		}
		else{
	...
	if(!order.equals("")){
		strsqlq = "select member_mas.member_name, reserve_mas.access_no, reserve_mas.res_date, reserve_mas.member_code from member_mas, reserve_mas, book_mas, sort_book where 1<2 and sort_book.access_no=reserve_mas.access_no "+strsql+" and doc_type='PROCEEDING' and reserve_mas.access_no=book_mas.access_no and book_mas.availability='YES' and member_mas.member_code=reserve_mas.member_code order by n1,n2,n3";
		}
		else{
	...
	if(!order.equals("")){
		strsqlq = "select member_mas.member_name, reserve_mas.access_no, reserve_mas.res_date, reserve_mas.member_code from member_mas, reserve_mas, book_mas, sort_book where 1<2 and sort_book.access_no=reserve_mas.access_no "+strsql+" and doc_type='REPORT' and reserve_mas.access_no=book_mas.access_no and book_mas.availability='YES' and member_mas.member_code=reserve_mas.member_code order by n1,n2,n3";
		}
		else{
	...
	if(!order.equals("")){
		strsqlq = "select member_mas.member_name, reserve_mas.access_no, reserve_mas.res_date, reserve_mas.member_code from member_mas, reserve_mas, book_mas, sort_book where 1<2 and sort_book.access_no=reserve_mas.access_no "+strsql+" and doc_type='NON BOOK' and reserve_mas.access_no=book_mas.access_no and book_mas.availability='YES' and member_mas.member_code=reserve_mas.member_code order by n1,n2,n3";
		}
		else{
	...
	if(!order.equals("")){
		strsqlq = "select member_mas.member_name, reserve_mas.access_no, reserve_mas.res_date, reserve_mas.member_code from member_mas, reserve_mas, book_mas, sort_book where 1<2 and sort_book.access_no=reserve_mas.access_no "+strsql+" and doc_type='STANDARD' and reserve_mas.access_no=book_mas.access_no and book_mas.availability='YES' and member_mas.member_code=reserve_mas.member_code order by n1,n2,n3";
		}
		else{
...
if ((txtreporttype.equals("Resreminder")) && (!txtdoctype.equals("ALL"))){
	if(report_type.equals("listing"))
	{
   	...
   	if(!order.equals("")){
		strsqlq = "select member_mas.member_name, reserve_mas.access_no, reserve_mas.res_date, reserve_mas.member_code from member_mas, reserve_mas, book_mas, sort_book where 1<2 and sort_book.access_no=reserve_mas.access_no "+strsql+" and doc_type='"+txtdoctype+"' and reserve_mas.access_no=book_mas.access_no and book_mas.availability='YES' and member_mas.member_code=reserve_mas.member_code order by n1,n2,n3";
		}
		else{
			strsqlq = "select member_mas.member_name, reserve_mas.access_no, reserve_mas.res_date, reserve_mas.member_code from member_mas, reserve_mas, book_mas where 1<2 "+strsql+" and doc_type='"+txtdoctype+"' and reserve_mas.access_no=book_mas.access_no and book_mas.availability='YES' and member_mas.member_code=reserve_mas.member_code "+order+"";	
		}
	...
	{
	total=0;
	strsqlq="select count(*) as count_book, reserve_mas.res_date, reserve_mas.access_no, book_mas.access_no, book_mas.availability from  reserve_mas, book_mas where 1<2 "+strsql+" and doc_type='"+txtdoctype+"' and reserve_mas.access_no=book_mas.access_no and book_mas.availability='YES' group by res_date,reserve_mas.access_no,book_mas.access_no,book_mas.availability order by res_date";
	...
	out.print("<font size=3>Document Type :"+txtdoctype+"</font>");
	out.print("<br><table border=1 width=700 align=center CELLSPACING='0' BORDERCOLOR='#DADADA' BGCOLOR='#F5F5F5'> ");
	out.print("<tr><th>Sno</th><th>ReserveDate</th><th>No Of "+txtdoctype+"</th></tr>");
