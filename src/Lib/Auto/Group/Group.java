      ...
      if(flag!=null){
		...
		if(Group_savestatus==null)
		{
			...
			if(flag.equals("search")){
				...
				ob=ss.getGroupSearch(request.getParameter("GCode"),branchID);
				if(ob!=null){
					request.setAttribute("bean", ob);
			...
			if(flag.equals("save")){
				log4jLogger.info("start===========save=====");
				 ...
				 newbean=ss.getGroupSearch(request.getParameter("GCode"),branchID);
				 ...
				 if(newbean!=null){
					 ...
					 int Gru_name=ss.getGroupNameInterface(Group_savename,branchID);
