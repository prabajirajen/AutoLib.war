...
public class SendDueReminderEmailJobforStudent implements Job
{
	private static Logger log4jLogger = Logger.getLogger(SendDueReminderEmailJobforStudent.class);
	...
	throws JobExecutionException {		
		...
		{			
			...
			int count=0;
			//ss.getDueReminderMail("ALL",2,"STUDENT");	
