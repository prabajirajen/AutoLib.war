...
public class SendDueReminderSMSJobforStudent implements Job
{
	private static Logger log4jLogger = Logger.getLogger(SendDueReminderSMSJobforStudent.class);
	...
	throws JobExecutionException {		
		...
		{			
			...
			int count=0;
			ss.getDueReminderSMS("ALL",2,"STUDENT");	
