...
//  call this calender function in html page like 
//  popUpCalendar(this<current page>,<form name. object name>,<format of calender mm/dd/yyyy>)
   ...
   function WeekNbr(n) {
	...
	function popUpCalendar(ctl,	ctl2, format, currDt) {
		var	leftpos=0
		var	toppos=0
		//alert(ctl)
		//alert(ctl2)
		//alert(format)
		dateNow = currDt.substring(0,2);
		monthNow = currDt.substring(3,5)-1;
		yearNow = currDt.substring(6,10);
