...
<%@ page language="java" session="true"  buffer="12kb" import="Lib.Auto.Review.ReviewBean" import="Lib.Auto.Advanced.Adsearchbean" import="Lib.Auto.Review.ReviewBean"
...
<%
            ...
            session.setAttribute("Title",view.getTitle());}sc.clear();%>
